...
if __name__ == '__main__':
    ...
    get_post_info("https://apartamento.mercadolibre.com.do/MRD-525801368-alquilo-apartamento-en-colinas-del-arroyo-ii-_JM#position=2&search_layout=grid&type=item&tracking_id=2b416fd4-2120-4ce8-a847-f99d5849a60d")
    #save_posts()
